...
import { type ColourMode, colourForCell } from "./colour";
import { longitudeOf, type Projection, projectPoint } from "./projection";

export type { ColourMode } from "./colour";
  ...
  updateVelocities(plateData: PlateData, data: CellData): void {
    ...
    for (const [id, centroid] of centroids) {
      ...
      const push = (
        ...
        pushSegment(segments, this.projection, refLon, ax, ay, az, bx, by, bz);
